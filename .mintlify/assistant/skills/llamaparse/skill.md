...
- Refer to the [example.ts](https://github.com/run-llama/llamaparse-agent-skills/blob/main/skills/llamaparse/scripts/example.ts) script, which covers most of the necessary configurations for LlamaParse
