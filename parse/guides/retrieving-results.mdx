...
`detected_form_types` carries the classifier's page-level form-type token so you can route or partition enriched-form pages without re-classifying them. It is a single-element array holding one of `w2`, `f1040`, `f1099_int`, `f1099_misc`, `f1099_nec`, `f1099_div`, `k1_1065`, `k1_1120s`, `k1_1041`, `acord_25`, `acord_125`, `acord_127`, `ss4`, `uscis`, or `other` (the catch-all for unknown, low-confidence, or non-tax forms). It is `null` on pages where no form was detected.
